...
function getSocketUrl(urlParts, loc) {
  ...
  if (process.env.SWEET_SOCKET === 'ws') {
    const location = window.location;

    (!urlObject.protocol) && (urlObject.protocol = location.protocol);
    (!urlObject.hostname) && (urlObject.hostname = location.hostname);
    (!urlObject.port) && (urlObject.port = location.port);
  }
